...
namespace GXPEngine
{
	...
	{
		readonly Dictionary<Texture2D, BufferRenderer> renderers;
	...
	public class BufferRenderer
	{
		...
		private static readonly List<float> vertListStatic = new List<float>();
		readonly List<float> vertList = vertListStatic;
		private static readonly List<float> uvListStatic = new List<float>();
		readonly List<float> uvList = uvListStatic;
